...
%>
        ...
        <tbody>
      <%
      ResultSet rs=st.executeQuery("select * from product inner join cart on product.id=cart.product_id and cart.email='"+email+"' and address is NULL");
      while(rs.next()){
    	   %>
          <tr>
           <%sno=sno+1; %>
           <td><%out.println(sno); %>
            ...
            <td><a href="removeFromCart.jsp">Remove<i class='fas fa-trash-alt'></i></a></td>
          </tr>
          <% 
          }
}
